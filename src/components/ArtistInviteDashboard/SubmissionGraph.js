...
export default class SubmissionGraph extends Component {
  ...
  isLoadedOrEmpty = () => {
    ...
    return !totalDailySubmissions.isEmpty()
  }
      ...
      <div className="chart-container half">
        ...
        {this.isLoadedOrEmpty() ?
          ...
          <div className="chart-structure loading">
            <div className="chart">
              <h4>{this.props.totalDailySubmissions === false ? 'Loading…' : 'Not enough data, yet…'}</h4>
            </div>
          </div>
        }
      </div>
